...
/usr/bin/python /home/pi/Desktop/mag.py >> mag.txt
...
/home/pi/Dropbox-Uploader/./dropbox_uploader.sh upload /home/pi/Desktop/mag.txt /sensehat/$(date -d "yesterday 13:00" '+%y-%m-%d').mag.txt
